proc template;
	...
	source StatGraph.TimeSeries.ResidualHistogram;
	define statgraph StatGraph.TimeSeries.ResidualHistogram;
   		dynamic title series _byline_ _bytitle_ _byfootnote_;
   		begingraph;
      		entrytitle title;
      		layout overlay / xaxisopts=(label="residuals" linearopts=(tickvalueformat=best12.))
