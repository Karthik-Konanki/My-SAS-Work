proc template;
	...
	source StatGraph.Decomposition.TrendCycleComponentPlot;
	define statgraph StatGraph.Decomposition.TrendCycleComponentPlot;
		...
		begingraph;
      		...
      		layout overlay / xaxisopts=(shortlabel=id label=idlabel type=idtype timeopts=(
         					...
         					integertime)) yaxisopts=(display=all griddisplay=auto_on label="trend-cycle");
         		...
         		seriesplot x=time y=eval (tcc (series, seasonality=seasonality, mode=mode)) /
            				...
            				tcc (series, seasonality=seasonality, mode=mode))) tiplabel=(ytipname="component"
            				) tip=(xtipname ytipname) lineattrs=graphfit legendlabel="trend-cycle" name=
            				"trend";
