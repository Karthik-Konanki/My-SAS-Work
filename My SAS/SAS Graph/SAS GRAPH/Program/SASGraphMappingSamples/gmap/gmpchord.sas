  /*+----------------------------------------------------------------------+
   ...
   |   PROCS: GMAP                                                        |
   |    DATA: MAPSGFK.US, SASHELP.US_DATA                                 |
   |                                                                      |
   | SUPPORT: GRAPHICS STAFF                           CREATED: 06MAR2022 |
   |     REF: SAS/GRAPH & BASE MAPPING REF. GUIDE                         |
   +----------------------------------------------------------------------+*/

/* Get the 2020 population data for NC, SC, and VA from SASHELP.US_DATA. */
%let year=2020;
data population;
   year=&year;
   set sashelp.us_data;
...
/* Specify a border and the map size. */
goptions reset=all border xpixels=510 ypixels=400;
