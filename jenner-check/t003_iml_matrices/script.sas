...
/* jenner-check: this bundle omits two lines here (an OPTIONS statement and
   a name-literal ('my name'n) variable assignment/print); everything else
   in the block is unmodified. */
