...
/* jenner-check: original bundled this run via PROC PRINTTO to a hardcoded
   E:\NewDisk\... log/lst path; removed for portability, log/listing come
   back through the normal Jenner response instead. */
